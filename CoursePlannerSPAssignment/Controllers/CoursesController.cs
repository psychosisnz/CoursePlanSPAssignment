...
namespace CoursePlannerSPAssignment.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CourseId,CourseCode,CourseName,Semester,Year,TopicId,PreReq,Compulsory")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CourseId,CourseCode,CourseName,Semester,Year,TopicId,PreReq,Compulsory")] Course course)
        {
            if (ModelState.IsValid)
            {
